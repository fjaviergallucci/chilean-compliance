...
**Out of scope:** CMF circulars, APDP guidance, sector-specific regulation,
case law, Título V of Ley 21.521 (modifications to other statutes), and
anything not in `sources/`. If asked about anything beyond the two laws
...
Cite as `Ley 19.628 Art. 8(g)` or `Ley 21.521 Art. 3(2)`. For the consolidated 19.628:
